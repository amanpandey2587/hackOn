...
export const WATCHMODE_API_KEY = "wOdG2B7Dgiy9fsosKaDdF4hv89nWRNxN3dnMD3Ba";
...
export const Top_Rated_Movie = `${WATCHMODE_BASE_URL}/list-titles/?apiKey=${WATCHMODE_API_KEY}&source_ids=203&types=movie&sort_by=popularity_desc&limit=20`;
export const Upcoming_Movie = `${WATCHMODE_BASE_URL}/list-titles/?apiKey=${WATCHMODE_API_KEY}&source_ids=203&types=movie&sort_by=release_date_desc&limit=20`;
